...
public static class DbInitializer
{
  public static void Initialize(DomainContext context)
  {
    ...
    {
      new Formula(new List<Equipment>(), "Basic", "For a small party"),
      new Formula(new List<Equipment> { bbq, tent }, "Extended", "For a medium sized party"),
      new Formula(new List<Equipment> { bbq, tent, barrel }, "Extended", "For the best party you could imagine")
    };
